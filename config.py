...
# werden. Landen SOFORT als status='active' in Supabase (Baustein 7:
# vollautonome Optimierung, kein manuelles Freigeben mehr - siehe
# query_suggestions.py).
MAX_QUERY_SUGGESTIONS_PER_RUN = 3

# Nach wie vielen Laeufen IN FOLGE OHNE neue Leads ein Suchbegriff automatisch
# stillgelegt wird (status='retired'). Verhindert, dass die Pipeline eine
# leergesuchte Stadt/Branche endlos weiter abfragt und dafuer API-Budget und
# Scoring-Kosten verschwendet. Siehe supabase_client.retire_exhausted_queries().
QUERY_EXHAUSTED_AFTER_EMPTY_RUNS = 3
